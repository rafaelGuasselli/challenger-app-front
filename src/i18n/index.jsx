...
const translations = {
	en: {
		...
		register: {
			...
			errorMessage: 'Registration failed. Check your data and try again.',
		},
		home: {
			...
			deleteConfirmMsg: 'Are you sure you want to delete your account? This action is permanent.',
		...
		profile: {
			...
			deleteQuestion: 'Are you sure you want to delete your account in Challengers App?',
	...
	pt: {
		...
		register: {
			...
			errorMessage: 'Falha no cadastro. Verifique os dados e tente novamente.',
		},
		home: {
			...
			deleteConfirmMsg: 'Tem certeza que deseja apagar sua conta? Esta ação é permanente.',
		...
		profile: {
			...
			deleteQuestion: 'Tem certeza que deseja excluir sua conta no Challengers App?',
